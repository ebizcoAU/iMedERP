...
const groupID = 2;
const distributorID = [5,103,191];
const salestaffID = [2,3,4];
const daynum = 10;
const loop = 100;
...
function genExpensex () { //prod = product list, dist= distributor list
    sqlTxt = `INSERT INTO ${tblx} (groupID, supplierID, salestaffID, dateDispatched, dateConfirmed, dateCompleted, datePaid, isPaid, status) VALUES `; 
    taskRec = [];   

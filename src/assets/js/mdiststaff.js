...
//*********************************************** */
    ...
    key: primekey,
    load(loadOptions) {
      if (roleID == 1) return sendRequest(`${URL}/diststaff/0`, 'POST')
      else if (roleID == 4) return sendRequest(`${URL}/diststaff/${mid}`, 'POST')
    },
  });
    ...
    columns: [
      ...
      { dataField: 'namex',
        ...
        calculateCellValue: function (rowData) { // combines display values
            return `${rowData.name}/${rowData.company}/${rowData.phone}`;
        },
